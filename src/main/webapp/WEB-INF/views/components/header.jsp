...
<link href="<c:url value="resources/vendor/bootstrap-multiselect/css/bootstrap-multiselect.css" />" rel="stylesheet" type="text/css">
			...
			<div class="navbar-default sidebar" role="navigation">
				<div class="sidebar-nav navbar-collapse">
					<ul class="nav" id="side-menu">
						...
						<li><a href="emp-list-view"><i class="fa fa-dashboard fa-fw"></i>Employees</a></li>
						<li><a href="tasks-list-view"><i class="fa fa-dashboard fa-fw"></i>Tasks</a></li>
						<li><a href="roles-list-view"><i class="fa fa-dashboard fa-fw"></i>Roles</a></li>
